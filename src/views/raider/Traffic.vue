      ...
      <div class="contents">
        <ul>
          <li>
              ...
              <p class="pp3">70元</p>
              <p class="pp4">
                可乘机场大巴至上清寺后转乘108路公交车至南坪，再转乘346或347路公交车到学校；或乘轻轨三号线到南坪，再转乘346或347路公交车到学校
              </p>
          </li>
          <li>
          ...
          <li>
              ...
              <p class="pp3">70元</p>
              <p class="pp4">
                1.可乘213路公交车到天星桥，转乘819路公交车至会展中心，再转乘346路公交车到学校 &nbsp; &nbsp;2.可乘426路公交车到南坪红星美凯龙，
                再转乘347路公交车到学校
              </p>
          </li>
          <li>
          ...
          <li>
              ...
              <p class="pp2">60分钟</p>
              <p class="pp3">1元</p>
              <p class="pp4">1.可乘坐校内观光车到教学楼、宿舍楼等 &nbsp; &nbsp;2.每人需自备一元现金车票</p>
          </li>
      </ul>
      </div>
    </scroll-bar>
