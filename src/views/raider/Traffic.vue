<template>
  <Frame styles="lantern">
    ...
    <div class="title">
      <div class="dir">出发地</div>
      <div class="time">预计时间</div>
      <div class="press">预计价格</div>
      ...
      <div class="contents">
        <ul>
          ...
          <li>
              ...
              <p class="pp3">40元</p>
              <p class="pp4">
                乘323路或168路公交车至南坪，转乘346或347路公交车至学校：或乘轻轨三号线到南坪，再转乘346或347路公交车到学校；直接打车到校费用约40元</p>
          </li>
          <li>
          ...
          <li>
              ...
              <p class="pp3">70元</p>
              <p class="pp4">
                1.可乘213路公交车到天星桥，转乘819路公交车至会展中心，再转乘346路公交车到学校2.可乘426路公交车到南坪红星美凯龙，
                再转乘347路公交车到学校3.直接打车到校费用约为70元
              </p>
          </li>
          <li>
